...
# app.config["SQLALCHEMY_DATABASE_URI"] = os.getenv("DATABASE_URL", "sqlite:///instance/wnba_fantasy_league.db")
database_url = os.getenv("DATABASE_URL", "sqlite:///data/wnba_fantasy_league.db")
